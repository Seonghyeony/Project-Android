package com.seonghyeon.android.airpollutionnotificationapp
...
import com.seonghyeon.android.airpollutionnotificationapp.data.Repository
import com.seonghyeon.android.airpollutionnotificationapp.data.models.airquality.Grade
...
import com.seonghyeon.android.airpollutionnotificationapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun displayAirQualityData(monitoringStation: MonitoringStation, measuredValue: MeasuredValue) {
        ...
        binding.contentsLayout.animate()
            .alpha(1F)  // duration을 따로 설정 안하면 default
            .start()
