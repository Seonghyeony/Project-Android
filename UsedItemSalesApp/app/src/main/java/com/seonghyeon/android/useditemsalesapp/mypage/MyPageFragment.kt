package com.seonghyeon.android.useditemsalesapp.mypage
...
import com.seonghyeon.android.useditemsalesapp.databinding.FragmentMypageBinding
                ...
                auth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(requireActivity()) { task ->
                        if (task.isSuccessful) {
                            ...
                            Toast.makeText(context, "회원가입에 실했습니다. 이미 가입한 이메일일 수 있습니다.", Toast.LENGTH_SHORT).show()
                        }
                    }
            }
        }
